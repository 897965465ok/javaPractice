...
import com.jiang.mall.model.dao.OrderItemMapper;
import com.jiang.mall.model.dao.OrderMapper;
import com.jiang.mall.model.dao.ProductMapper;
import com.jiang.mall.model.pojo.Order;
import com.jiang.mall.model.pojo.OrderItem;
...
import com.jiang.mall.model.vo.OrderItemVO;
...
import com.jiang.mall.util.OrderCodeFactory;
import com.jiang.mall.util.QRCodeGenerator;
...
//    @Transactional(rollbackFor = Exception.class)
    ...
    public String create(CreateOrderReq createOrderReq) {
        ...
        if (CollectionUtils.isEmpty(cartVOList)) {
            throw new MallException(MallExceptionEunm.CART_EMPTY);
        }
        //判断商品是否存在、上下架状态、库存
        ...
        //生成订单号，有独立的规则
        String OrderNumber = OrderCodeFactory.getOrderCode(Long.valueOf(userId));
    ...
    public OrderVO detail(String orderNo) {
        ...
        if (order == null) {
            throw new MallException(MallExceptionEunm.NO_ORDER);
        }
        // 订单存在，需要判断所属
        Integer userId = UserFilter.currentUser.getId();

        if (!order.getUserId().equals(userId)) {
            throw new MallException(MallExceptionEunm.NO_BELONG_YOU);
        }
    ...
    public void cancel(String orderNo) {
        ...
        if (order.getOrderStatus().equals(Constant.OrderStatusEnum.NOT_PAID.getCode())) {
            ...
            throw new MallException(MallExceptionEunm.WRONG_ORDER_STATUS);
        }
