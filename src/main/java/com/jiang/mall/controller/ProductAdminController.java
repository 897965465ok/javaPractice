...
import com.jiang.mall.model.request.UpdateProductReq;
...
public class ProductAdminController {
    ...
    public ApiRestResponse addProductReq(@Valid @RequestBody AddProductReq addProductReq) {
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) {
        ...
        if (!fileDirectory.exists()) {
            if (!fileDirectory.mkdirs()) {
                throw new MallException(MallExceptionEunm.MAKE_FAILED);
            }
        }
        try {
            ...
            e.printStackTrace();
            return ApiRestResponse.error(MallExceptionEunm.MAKE_FAILED);
        }
        try {

            String  filePath =    getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/images/" + newFileName;
